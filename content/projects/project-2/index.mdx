...
<div className="flex items-center justify-center gap-8 mb-8 p-6 bg-gray-900 rounded-lg">
...
<div className="flex items-center justify-center gap-8 mb-6">
  <div className="tooltip" data-tip="Agno Framework">
    <Image src="/dcp-guardian-project/agno logo.jpg" alt="Agno Logo" width={80} height={80} className="inline-block object-contain" />
  </div>
  <div className="tooltip" data-tip="Azure OpenAI">
    <Image src="/dcp-guardian-project/azure-openai.png" alt="Azure OpenAI Logo" width={140} height={140} className="inline-block object-contain" />
  </div>
  <div className="tooltip" data-tip="ChromaDB">
    <Image src="/dcp-guardian-project/chroma-logo.png" alt="ChromaDB Logo" width={120} height={80} className="inline-block object-contain" />
  </div>
</div>
