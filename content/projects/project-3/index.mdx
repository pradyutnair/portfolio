...
| Metric | DEWan Score | Ranking |
| --- | --- | --- |
| **Video Quality** | 0.89 | Top 5 |
| **Identity Preservation** | 0.94 | **2nd** (Single-Domain) |
| **Motion Smoothness** | 0.87 | Top 10 |
| **Overall AUC** | 92.7% | **4th** (Human-Domain) |
